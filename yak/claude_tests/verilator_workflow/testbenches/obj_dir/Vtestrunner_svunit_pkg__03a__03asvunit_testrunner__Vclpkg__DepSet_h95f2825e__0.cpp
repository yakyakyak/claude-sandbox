...
void Vtestrunner_svunit_pkg__03a__03asvunit_testrunner::__VnoInFunc_get_num_passing_testsuites(Vtestrunner__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_passing_testsuites__Vfuncrtn) {
    ...
    while (VL_LTS_III(32, unnamedblk1__DOT__i, this->__PVT__list_of_suites.size())) {
        if (([&]() {
                    VL_NULL_CHECK(this->__PVT__list_of_suites.at(unnamedblk1__DOT__i), "/Users/yak/Projects/Claude/claude_hardware_projects/claude-sandbox/yak/verilator_workflow/testbenches/../svunit/svunit_base/svunit_testrunner.sv", 44)
