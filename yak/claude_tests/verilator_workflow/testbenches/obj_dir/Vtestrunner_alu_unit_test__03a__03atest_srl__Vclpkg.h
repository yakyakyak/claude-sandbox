...
#ifndef VERILATED_VTESTRUNNER_ALU_UNIT_TEST__03A__03ATEST_SRL__VCLPKG_H_
#define VERILATED_VTESTRUNNER_ALU_UNIT_TEST__03A__03ATEST_SRL__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtestrunner_alu_unit_test__03a__03atest_srl__Vclpkg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtestrunner_alu_unit_test__03a__03atest_srl__Vclpkg(Vtestrunner__Syms* symsp, const char* v__name);
    ~Vtestrunner_alu_unit_test__03a__03atest_srl__Vclpkg();
    VL_UNCOPYABLE(Vtestrunner_alu_unit_test__03a__03atest_srl__Vclpkg);
...
class Vtestrunner_alu_unit_test__03a__03atest_srl : public Vtestrunner_svunit_pkg__03a__03asvunit_test {
  public:
  ...
  public:
    Vtestrunner_alu_unit_test__03a__03atest_srl(Vtestrunner__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtestrunner_alu_unit_test__03a__03atest_srl() {}
};
